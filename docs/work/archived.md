...
| `locale-switcher`             | 2026-09-02 | Selettore di lingua nella barra dell'header a ogni larghezza, CTA a icona sotto 400px, cookie scritto solo su scelta esplicita | v1.4.0                                         |
