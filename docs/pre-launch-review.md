...
- `scripts/faq/*.mjs` (01-07) — keep as the documented FAQ-migration audit trail (`docs/work/archive/2026-06-01-faq-section/slices.md`); future schema work goes through `migrations/`.
...
- **No leftover plumguide files** — `plumguide-design` is a global Claude skill outside the repo; the only "Plum Guide" hits are inspiration prose in `docs/work/archive/2026-03-15-apartment-detail-redesign/pitch.md`.
